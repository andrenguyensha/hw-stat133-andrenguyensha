#Andre Sha's Data Preparation Phase Script
#In this Data Script, I aggregate players' data and add columns
#Inputs: andre-iguodala.csv, stephen-curry.csv, kevin-durant.csv, klay-thompson.csv, draymond-green.csv
#Outputs: shots-data.csv, player data summaries
